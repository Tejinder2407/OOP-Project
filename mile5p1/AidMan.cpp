...
namespace sdds {
    ...
    void AidMan::run() {
        ...
        do {
            unsigned int option_selected = menu();

            if (option_selected != 0 && fileName == nullptr && option_selected != 7) {
                option_selected = 7;
    ...
    int AidMan::list(const char* sub_desc) {
        ...
        int indexes_printed[sdds_max_num_items];
        if (sub_desc == nullptr) {
            ...
            if (noProductsPrinted > 0) {
                ...
                for (int i = 0; i < noProductsPrinted; i++) {
                    ...
                    cout.width(3);
                    cout << i + 1 << " | ";
                    allItems[indexes_printed[i]]->linear(true);
                    allItems[indexes_printed[i]]->display(cout);
                    cout << endl;
        ...
        if (noProductsPrinted > 0) {
            ...
            if (cin.peek() == '\n') {
                ...
                allItems[indexes_printed[option - 1]]->linear(false);
                allItems[indexes_printed[option - 1]]->display(cout);
                cout << endl << endl;
